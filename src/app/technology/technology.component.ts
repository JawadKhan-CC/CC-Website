      ...
      items: [
        {
          ...
          content: `
➤ Build highly scalable enterprise applications trusted by global businesses.
...
➤ Enable IoT and embedded systems with reliable Java-based solutions.`
        },
        {
          ...
          content: `
➤ Build highly scalable enterprise applications trusted by global businesses using Node.js.
...
➤ Optimize performance with Angular’s modular architecture.
        ...
        },
        {
          ...
          content:  `
➤ Develop interactive web applications with Vue.js.
...
➤ Ideal for single-page apps, dashboards, and progressive apps.`
        },
        {
          ...
          content: `
➤ Build AI, machine learning, and automation solutions.
...
➤ Leverage Python for web, mobile, and desktop applications.`
        },
        {
          ...
          content: `
➤ Host scalable and reliable applications on AWS cloud.
...
➤ Monitor and optimize performance with CloudWatch and CloudTrail.`
        },
        {
          ...
          content: `
➤ Implement secure internet access and cloud security solutions.
...
➤ Integrate with cloud applications for visibility and control.`
        },
        {
          ...
          content: `
➤ Build and customize CRM solutions for sales, service, and marketing.
